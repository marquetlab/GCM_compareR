...
**a. General Circulation Models (GCMs).** Check the climatic models of interest and uncheck those that should not be included in the comparison. Use the tab *GCM details* above the map to toggle a table with details for any climate model. Not all models are available for all combination of scenarios (GCMs and year).  
